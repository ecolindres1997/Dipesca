...
if (!isset($EMAIL)) {
 ...
 ?>
    ...
    <div class="form-group">
      <label for="nombre1">Nombre Cientifico</label>
      <input type="text" name="NombreCient" class="form-control" class="required"
      value="<?php echo $NombreCient; ?>"placeholder="Ingrese el nombre Cientifico">
      </div>
        </div>
            <div class=" col-sm-12 col-md-12">
    <div class="form-group">
      <label for="nombre1">Nombre Comun</label>
      <input type="text" name="NombreComun" class="form-control" class="required"
      value="<?php echo $NombreComun; ?>"placeholder="Ingrese el nombre Comun">
      </div>
        </div>
      </div>
