...
<p class="font-weight-bolder">Especies Registradas</p>
</div>
<?php
...
$sql='SELECT * FROM especie LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($conexion, $sql);?>
<table class="table table-hover">
  <thead>
    <tr>
      <th scope="col-sm-12 col-md-4 col-lg-4">id</th>
      <th scope="col-sm-12 col-md-4 col-lg-4">Nombre Cientifico</th>
         <th scope="col-sm-12 col-md-4 col-lg-4">Nombre Comun</th>
...
<?php
    ...
    <tr>
      ...
      <td>
         <a href="agrega_especie.php?edit=<?php echo $row ['id']; ?>"
...
<?php endwhile; ?>
   ...
   <div class="container">
        ...
        <a href="agrega_especie.php"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSUVhYfDrJ4IrETdVNUPKPxM2jBzK25yAUl2zX8lGxhMffqnnRn"width="50" height="40">Agregar Especie</a>
