...
$sql='SELECT embarcacion.id,embarcacion.nombre_embarcacion, embarcacion.modelo, embarcacion.bandera,
tipo_embarcacion.nombre_tipo from embarcacion  join tipo_embarcacion on embarcacion.id_tipo = tipo_embarcacion.id LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($conexion, $sql);?>
<table class="table table-hover">
  <thead>
    <tr>
      <th scope="col-sm-12 col-md-4 col-lg-1">id</th>
      <th scope="col-sm-12 col-md-4 col-lg-3">Nombre de embarcacion</th>
      <th scope="col-sm-12 col-md-4 col-lg-3">Tipo de Embarcacion</th>
      <th scope="col-sm-12 col-md-4 col-lg-2">Modelo </th>
      <th scope="col-sm-12 col-md-4 col-lg-3 ">Bandera</th>
...
<?php
    ...
    <tr>
      ...
      <td>
         <a href="agrega_embarca.php?edit=<?php echo $row ['id']; ?>"
...
<?php endwhile; ?>
   ...
   <div class="container">
        ...
        <a href="agrega_embarca.php"><img src="https://i.pinimg.com/originals/13/e8/82/13e8829673a31039fbb6b1cfa374fd70.png"width="50" height="40">Agregar Embarcacion</a>
