...
$sql='SELECT * FROM empresa LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($conexion, $sql);?>
<table class="table table-hover">
  <thead>
    <tr>
      <th scope="col-sm-12 col-md-6 col-lg-3">id</th>
      <th scope="col-sm-12 col-md-6 col-lg-3">Nombre</th>
      <th scope="col-sm-12 col-md-6 col-lg-3">Email</th>
      <th scope="col-sm-12 col-md-6 col-lg-3">Nit </th>
...
<?php
    ...
    <tr>
      ...
      <td>
         <a href="agrega_empresa.php?edit=<?php echo $row ['id']; ?>"
...
<?php endwhile; ?>
   ...
   <div class="container">
        ...
        <a href="agrega_empresa.php"><img src="https://png.pngtree.com/png-clipart/20190705/original/pngtree-offices-icon-for-personal-and-commercial-use-png-image_4341941.jpg"width="50" height="40">Agregar Empresa</a>
