...
$sql='SELECT anexo4.id, anexo4.fecha_sistema,anexo4.Contenedor_numero,anexo4.name, usuario.primer_nombre, usuario.primer_apellido, certificado_captura.codigo_certificado, anexo4.size FROM detalle_anexo join anexo4 on detalle_anexo.id_anexo = anexo4.id join usuario on anexo4.id_usuario = usuario.id join  certificado_captura on anexo4.id_certificado = certificado_captura.id  LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($conexion, $sql);?>
...
<?php
    ...
    <tr>
        <td><a href="Busca.php?Info=<?php echo $row ['id']; ?>"><?php  echo $row['id']; ?></td>
                    ...
                    <td><?php  echo $row['Contenedor_numero']; ?></td>
                    ...
                    <td><?php  echo $row['name']; ?></td>
                     <td><a href="download.php?file_id=<?php echo $row ['id']; ?>" ><img height="50px" src="https://icons.iconarchive.com/icons/graphicloads/100-flat/256/download-2-icon.png"></a>
                                       ...
                                       <td>
        <a href="nuevo_anexo.php?edit=<?php echo $row ['id']; ?>"
...
<?php endwhile; ?>
   ...
   <div class="container">
        ...
        <a href="nuevo_anexo.php"><img src="https://cdn.icon-icons.com/icons2/20/PNG/256/business_application_addmale_useradd_insert_add_user_client_2312.png "width="50" height="40">Nuevo Anexo</a>
