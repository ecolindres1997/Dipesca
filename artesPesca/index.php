...
$sql='SELECT * FROM arte_pesca LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($conexion, $sql);?>
<table class="table table-hover">
  <thead>
    <tr>
      <th scope="col-sm-12 col-md-4 col-lg-4">id</th>
      <th scope="col-sm-12 col-md-4 col-lg-4">Nombre</th>
...
<?php
    ...
    <tr>
        <td><a href="Busca.php?Info=<?php echo $row ['id']; ?>"><?php  echo $row['id']; ?></td>
                    <td><?php  echo $row['nombre_arte']; ?></td>

                               
      <td>
         <a href="agrega_arte.php?edit=<?php echo $row ['id']; ?>"
...
<?php endwhile; ?>
   ...
   <div class="container">
        ...
        <a href="agrega_arte.php"><img src="https://png.clipart.me/istock/previews/5856/58560898-square-button-with-fishing-hook-royalty-free-vector-art.jpg"width="50" height="40">Agregar arte</a>
