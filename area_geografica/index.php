...
$sql='SELECT * FROM litoral LIMIT ' . $this_page_first_result . ',' .  $results_per_page;
$result = mysqli_query($conexion, $sql);?>
<table class="table table-hover">
  <thead>
    <tr>
      <th scope="col-sm-12 col-md-4 col-lg-4">id</th>
      <th scope="col-sm-12 col-md-4 col-lg-4">Area Geografica</th>
...
<?php
    ...
    <tr>
        <td><a href="Busca.php?Info=<?php echo $row ['id']; ?>"><?php  echo $row['id']; ?></td>
                    <td><?php  echo $row['nombre_litoral']; ?></td>

                               
      <td>
         <a href="agrega_area.php?edit=<?php echo $row ['id']; ?>"
...
<?php endwhile; ?>
   ...
   <div class="container">
        ...
        <a href="agrega_Area.php"><img src="https://lh3.googleusercontent.com/proxy/tcaLDJCYHUHYohD1Ig9VfmdhLLwTpeqKjppLgNGlsubr8rNDZEJh1xo3Ulygo_0zJG8AYHsSbONx7kt4Tp_cpR42UtCX_P4FImCFf5d1_diThURL9A"width="50" height="40">Agregar area geografica</a>
