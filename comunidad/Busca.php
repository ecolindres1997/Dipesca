...
if (!isset($EMAIL)) {
 ...
 ?>
    ...
    <div class="form-group">
      <label for="nombre1">Nombre de la Arte</label>
      <input type="text" class="form-control" value="<?php echo $NombreComunidad; ?>" disabled>
      </div>
        </div>
      </div>
        <div class="row">
            ...
            <div class="form-group">
            <label for="nombre1">Nombre de la Arte</label>
            <input type="text" class="form-control" value="<?php echo $IdAgeo; ?>" disabled>
            </div>
              </div>
     </div>
